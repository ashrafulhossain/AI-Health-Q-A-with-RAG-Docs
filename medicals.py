...
#         embeddings = OpenAIEmbeddings(openai_api_key=openai_api_key)
#         vector_store = FAISS.load_local("faiss_index", embeddings, allow_dangerous_deserialization=True)  # Updated line
#     else:
#         print("❌ No existing FAISS index found, creating a new one...")
#         vector_store = process_multiple_pdfs(pdf_files)
#         vector_store.save_local("faiss_index")  # Save the new index
